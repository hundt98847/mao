...
static struct MaoStringPiece GetStringPiece(const char *before_pointer,
                                            const char *after_pointer) {
  struct MaoStringPiece sp = {before_pointer, after_pointer-before_pointer};
  return sp;
}
...
dot_cfi (int arg)
{
  offsetT offset;
  unsigned reg1, reg2;
  const char *before_pointer;
  const char *after_pointer;
  const char *before_pointer2;
  const char *after_pointer2;
  int num_regs;
  struct MaoStringPiece regs[64];
  ...
  switch (arg)
    {
    case DW_CFA_offset:
      before_pointer = input_line_pointer;
      reg1 = cfi_parse_reg ();
      after_pointer = input_line_pointer;
      cfi_parse_separator ();
      offset = cfi_parse_const ();
      cfi_add_CFA_offset (reg1, offset);
      link_cfi_offset_direcive(GetStringPiece(before_pointer, after_pointer),
                               offset);
      break;
    ...
    case CFI_rel_offset:
      ...
      link_cfi_rel_offset_direcive(GetStringPiece(before_pointer, after_pointer),
                                   offset);
      break;
    ...
    case DW_CFA_def_cfa:
      ...
      link_cfi_def_cfa_direcive(GetStringPiece(before_pointer, after_pointer),
                                offset);
      break;
    ...
    case DW_CFA_register:
      ...
      after_pointer = input_line_pointer;
      cfi_parse_separator ();
      before_pointer2 = input_line_pointer;
      reg2 = cfi_parse_reg ();
      after_pointer2 = input_line_pointer;
      cfi_add_CFA_register (reg1, reg2);
      link_cfi_register_direcive(GetStringPiece(before_pointer, after_pointer),
                                 GetStringPiece(before_pointer2,
                                                after_pointer2));
      break;
    ...
    case DW_CFA_def_cfa_register:
      ...
      link_cfi_def_cfa_register_direcive(GetStringPiece(before_pointer,
                                                        after_pointer));
      break;
    ...
    case DW_CFA_def_cfa_offset:
      ...
      link_cfi_def_cfa_offset_direcive(offset);
      break;
    ...
    case CFI_adjust_cfa_offset:
      ...
      cfi_add_CFA_def_cfa_offset (frchain_now->frch_cfi_data->cur_cfa_offset
				  + offset);
      link_cfi_adjust_cfa_offset(offset);
      break;
      ...
      for (;;)
	{
	  ...
	  reg1 = cfi_parse_reg ();
          after_pointer = input_line_pointer;
          gas_assert(num_regs < 64);
          regs[num_regs++] = GetStringPiece(before_pointer, after_pointer);
      ...
      link_cfi_restore_direcive(num_regs, regs);
      break;
      ...
      for (;;)
	{
      ...
      link_cfi_undefined_direcive(num_regs, regs);
      break;
    ...
    case DW_CFA_same_value:
      ...
      link_cfi_same_value_direcive(GetStringPiece(before_pointer,
                                                  after_pointer));
      break;
    ...
    case CFI_return_column:
      ...
      link_cfi_return_column_direcive(GetStringPiece(before_pointer,
                                                     after_pointer));
      break;

    case DW_CFA_remember_state:
      cfi_add_CFA_remember_state ();
      link_cfi_remember_state_direcive();
      break;

    case DW_CFA_restore_state:
      cfi_add_CFA_restore_state ();
      link_cfi_restore_state_direcive();
      break;

    case DW_CFA_GNU_window_save:
      cfi_add_CFA_insn (DW_CFA_GNU_window_save);
      link_cfi_window_save_direcive();
      break;

    case CFI_signal_frame:
      frchain_now->frch_cfi_data->cur_fde_data->signal_frame = 1;
      link_cfi_signal_frame_direcive();
      break;
...
dot_cfi_personality (int ignored ATTRIBUTE_UNUSED)
{
  ...
  if (encoding == DW_EH_PE_omit)
    {
      ...
      link_cfi_personality_direcive(encoding, NULL);
      return;
    }
  ...
  demand_empty_rest_of_line ();
  link_cfi_personality_direcive(encoding, &fde->personality);
}
...
dot_cfi_lsda (int ignored ATTRIBUTE_UNUSED)
{
  ...
  if (encoding == DW_EH_PE_omit)
    {
      ...
      link_cfi_lsda_direcive(encoding, NULL);
      return;
    }
  ...
  demand_empty_rest_of_line ();
  link_cfi_lsda_direcive(encoding, &fde->lsda);
}
...
dot_cfi_val_encoded_addr (int ignored ATTRIBUTE_UNUSED)
{
  ...
  const char *before_pointer = input_line_pointer;
  insn_ptr->u.ea.reg = cfi_parse_reg ();
  struct MaoStringPiece link_reg = {before_pointer,
                                    input_line_pointer-before_pointer};
  ...
  struct MaoStringPiece link_label = {before_pointer,
                                      input_line_pointer-before_pointer};
  ...
  demand_empty_rest_of_line ();
  link_cfi_val_encoded_addr_direcive(link_reg, encoding, link_label);
}
...
dot_cfi_startproc (int ignored ATTRIBUTE_UNUSED)
{
  ...
  if ((cfi_sections & CFI_EMIT_target) != 0)
    tc_cfi_startproc ();
  link_cfi_startproc_directive(simple);
}
